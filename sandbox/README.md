...
4. The Sandbox returns only the safe JSON schemas back to the main openMCP database.
...
3. Connect your GitHub repository containing the `mcp-registry-next` code.
