...
const SEARCH_INDEX = [
  ...
  { section: 'quickstart',        label: 'Quickstart',         text: 'quickstart system prompt agents.md add native mcp server claude desktop cursor antigravity config json restart ide search_tools invoke_tool skill file curl agents.md live stats teaches agent trust scores how to search read inputschemasad' },
